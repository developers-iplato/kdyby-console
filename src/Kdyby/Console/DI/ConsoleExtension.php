...
class ConsoleExtension extends Nette\DI\CompilerExtension
{
	...
	public function loadConfiguration()
	{
		...
		if (class_exists('Symfony\Component\Console\Helper\ProgressHelper')) {
			$entity = 'Symfony\Component\Console\Helper\ProgressHelper';
			$arguments = array();
			if (method_exists($entity, '__construct')) {
				$arguments = array(false);
			}
			$helperClasses[] = new Nette\DI\Statement($entity, $arguments);
		}

		if (class_exists('Symfony\Component\Console\Helper\DialogHelper')) {
			$entity = 'Symfony\Component\Console\Helper\DialogHelper';
			$arguments = array();
			if (method_exists($entity, '__construct')) {
				$arguments = array(false);
			}
